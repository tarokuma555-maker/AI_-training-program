...
export const metadata: Metadata = {
  ...
  description:
    "現場経験者（飲食店長・施工管理・介護職など）を、同じ業界のホワイトカラー職への転職につなげる6週間プログラム。AI研修付き・受講料無料。",
  openGraph: {
    type: "website",
    locale: "ja_JP",
    url: siteUrl,
    ...
    description:
      "AI研修付き転職支援プログラム（6週間・受講料無料）。現場での判断・管理の経験を、応募書類と面接で伝わる言葉に翻訳します。",
  },
  twitter: {
    card: "summary_large_image",
    title: "現場の経験を、次のキャリアの武器に。",
    description:
      "AI研修付き転職支援プログラム（6週間・受講料無料）",
  },
};
